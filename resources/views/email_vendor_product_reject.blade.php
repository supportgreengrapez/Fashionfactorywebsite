            ...
            <td align="center" bgcolor="#fbfcfd"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center"><!-- padding -->
                    ...
                    <div style="line-height: 44px;"> <font face="Arial, Helvetica, sans-serif" size="5" color="#57697e" style="font-size: 34px;"> <span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;"> Product Rejected </span></font> </div>
                ...
                <tr>
                  <td><div style="line-height: 24px;"> <font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;"> <b>Hello {{$customer_fname}},</b><br>
                      <span  style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">We have received your request to add products in your shop at YOC however we are sorry that we cannot add this product to the shop as it is not allowed hence Your product has been rejected. However, feel free to add other products. We will gladly review them. Thanks.</span></font> </div>
