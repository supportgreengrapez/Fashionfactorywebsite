        ...
        <table id="example1" class="table no-margin">
                ...
                <tbody>
                        ...
                        <tr>
                          ...
                          <td><span id="{{$results->pk_id}}" onclick="getId(this.id)" class="label label-warning" data-toggle="modal" data-target="#myModal">Canceled</span></td>
                          @elseif($results->v_order_status ==3 )
                          <td><span id="{{$results->pk_id}}" onclick="getId(this.id)" class="label label-danger" data-toggle="modal" data-target="#myModal">Returned</span></td>
                          @elseif($results->v_order_status ==4 )
                          <td><span id="{{$results->pk_id}}" onclick="getId(this.id)" class="label label-sucess" data-toggle="modal" data-target="#myModal">Delivered</span></td>
                          @endif
