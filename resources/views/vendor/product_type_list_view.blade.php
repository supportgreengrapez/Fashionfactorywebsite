                    ...
                    <table id="example1" class="table no-margin">
                      ...
                      <tbody>
                            ...
                            <tr>          
                              ...
                              <td><a href="{{URL('/')}}/vendor/home/edit/product/type/{{$results->pk_id}}">Edit</a>
                                  <a href="{{URL('/')}}/vendor/home/delete/product/type/{{$results->pk_id}}" style="margin-left:10px;">Delete</a></td>
                            </tr>
