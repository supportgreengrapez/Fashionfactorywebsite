 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <!-- Color Picker -->
                 <div class="form-group">
                  <label>Color</label>
                <div class="dropdown">
                            <button class="btnn _select_color dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{$result[0]->color}}<span class="caret _right"></span>
                            <span _text_display="{{$result[0]->color}}" @if($result[0]->color == "Green") class="color green" @endif @if($result[0]->color == "Red") class="color red" @endif @if($result[0]->color == "Yellow") class="color yellow" @endif 
                            ...
                            @if($result[0]->color == "OLIVE") class="color OLIVE" @endif @if($result[0]->color == "LIME") class="color LIME" @endif ></span></button>
                            ...
                            <input type="hidden" name="_color" value="{{$result[0]->color}}"></ul>
                        </div>
                </div><!-- /.form group -->
