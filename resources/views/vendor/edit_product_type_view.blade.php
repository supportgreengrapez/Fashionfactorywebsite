 ...
 <div class="content-wrapper">
        ...
        <div class=" col-md-5">
            <div class="form-login">
                    ...
                    <form method="post" action = "{{url('/')}}/vendor/home/edit/product/type/{{$results->pk_id}}" class="login-form">
                        {{ csrf_field() }}
                                         @if($errors->any())
  ...
  <strong>Danger!</strong> {{$errors->first()}}
	...
	@endif
            ...
            <input type="text" id="product type" name="productType" class="form-control input-sm chat-input" value = "{{$results->product_type}}"placeholder="product type" />
            <br>
