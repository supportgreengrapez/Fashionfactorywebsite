 ...
 <div class="content-wrapper">
  ...
  <strong>Danger!</strong> {{$errors->first()}}
	...
	@endif
        ...
        <input type="text" name ="brandname"  class="form-control input-sm chat-input" value="{{$results->brand_name}}" placeholder="Enter brand"/>
<br>    
<label for="text">Image</label>
<input type="file" name="file" value="{{$results->thumbnail}}" onchange="readURL(this);" />    
