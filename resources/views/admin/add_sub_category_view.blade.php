 ...
 <div class="content-wrapper">
        ...
        <div class=" col-md-6">
            <div class="form-login">
                    <form method="post" action = "{{url('/')}}/admin/home/add/sub/category" enctype="multipart/form-data" class="login-form">
                        {{ csrf_field() }}
                        @if($errors->any())
  ...
  <strong></strong> {{$errors->first()}}
	...
	@endif
       ...
       @endif
            ...
            <input type="text" id="Main category Name" name="subCategory"  class="form-control input-sm chat-input" placeholder="Sub Category Name" />
            <br>
